...
export type Login_AdminMutation = {
  __typename?: 'Mutation'
...
export const Login_AdminDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'LOGIN_ADMIN' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<Login_AdminMutation, Login_AdminMutationVariables>

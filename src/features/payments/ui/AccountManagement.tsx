  ...
  data: [
    {
      ...
      endDateOfSubscription: '2024-11-30',
      subscriptionId: '1',
      userId: 1,
    },
    {
      autoRenewal: false,
      dateOfPayment: '2024-10-31',
      endDateOfSubscription: '2024-10-31',
      subscriptionId: '12',
      userId: 2,
    },
    // {
...
export const AccountManagement = () => {
  ...
  const textForSubscriptionsTypes =
  ...
  return (
    <div className={'relative'}>
      ...
      {accountType === 'Business' && (
        <>
          <SubscriptionTypeCard text={textForSubscriptionsTypes} />

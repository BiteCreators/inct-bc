  ...
  return (
    <Component
      className={cn(
        ...
        variant === 'secondary' && 'bg-dark-300',
        'hover:bg-dark-500',
        'active:bg-dark-600',
        'disabled:bg-dark-300 disabled:hover:bg-dark-300',
        variant === 'outline' && 'bg-none border-primary-500 border text-primary-500',
        'hover:border-primary-700 hover:text-primary-700 ',
        'disabled:border-primary-500 disabled:text-primary-500 disabled:hover:border-primary-500 disabled:hover:text-primary-500', // Отключение ховера при disabled

      ...
      >
        <span
          className={cn(
            ...
            disabled &&
              'opacity-60 cursor-default hover:before:bg-transparent hover:bg-transparent active:before:bg-transparent active:bg-transparent focus:before:bg-transparent focus:bg-transparent'
          )}
        ></span>
        <span>{label}</span>
      </label>
